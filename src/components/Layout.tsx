          ...
          <div className="sticky top-0 z-30 flex items-center justify-between px-4 py-4 bg-white shadow-sm border-b lg:px-6">
            ...
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <div className="flex items-center space-x-3 space-x-reverse">
                <img
                  src="https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=32&h=32&fit=crop"
                  alt="פרופיל"
                  className="h-8 w-8 rounded-full"
                />
                <div className="hidden md:block">
                  <p className="text-sm font-medium text-gray-900">יוחנן דו</p>
